            ...
            try:
                ...
                for i in range(9, -1, -1):
                    ...
                    if str(post) in posting:
                        ...
                        data = {"username": "Moulamax",
                                "avatar_url": "https://media.discordapp.net/attachments/1041293387174789181/1041793844703936563/standard.gif",
                                "embeds": [
                                    {
                                        ...
                                        "footer": {
                                            "text": f"Vive Moulamax !",
                                            "icon_url": "https://media.discordapp.net/attachments/1041293387174789181/1041793844703936563/standard.gif"
                                        }
                                    }]}
